...
export function renderChatRoom(roomId, initialData) {
  ...
  var css = [
    ...
    '.we-action-btn.warn{background:#c0392b;color:#fff;border-color:#c0392b}',
  ...
  // IMPORTANT: every element in this array must be a single-line string with no embedded newlines.
  // Use \\n (escaped) inside string values that should appear as newlines in the browser JS output.
  var js = [
